        ...
        <div className="flex flex-col md:flex-row md:items-stretch justify-between">
          ...
          <div className="md:w-2/3">
            <div className="p-8 rounded-lg relative h-full">
              <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-blue-500 to-blue-700 blur-xl opacity-10 dark:opacity-30"></div>
              <div className="relative z-10 bg-white dark:bg-gray-900 rounded-lg border-2 border-blue-500 border-opacity-20 p-6 h-full">
                ...
                <div className="hidden xl:flex justify-between items-center mb-4">
                  <div className="flex xl:flex-row">
                    <div className="bg-white dark:bg-gray-800 border border-black dark:border-gray-700 rounded-md p-2 mr-20 flex items-center w-48 xl:block hidden">
                      <Image
                        src="/education.png"
                        alt="Education Icon"
                        width={20}
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-black dark:border-gray-700 rounded-md p-2 flex items-center w-48 xl:block hidden">
                      <Image
