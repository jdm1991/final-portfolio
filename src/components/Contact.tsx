    ...
    <div className="bg-white dark:bg-gray-900 py-20">
      <div className="container mx-auto px-4 md:px-8">
        <div className="p-8 rounded-lg relative">
          ...
          <div className="relative z-10 bg-white dark:bg-gray-800 rounded-lg border-2 border-blue-500 border-opacity-20 p-6">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-16">
              ...
              {/* LinkedIn Button */}
              <Link href="https://www.linkedin.com/in/jack-miller-495798281/">
